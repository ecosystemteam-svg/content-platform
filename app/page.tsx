          ...
          return (
            <Link href={`/article/${a.id}`} key={a.id} className="bg-white rounded-xl overflow-hidden shadow-sm border border-slate-200 hover:shadow-md transition">
              <div className="flex gap-3.5 p-3.5">
                {a.cover_image && <img src={a.cover_image} alt="" className="w-[90px] h-[90px] rounded-lg object-cover flex-shrink-0 bg-slate-100" />}
                <div className="flex-1 min-w-0 flex flex-col">
                  ...
                  <div className="flex items-center gap-2.5 mt-auto pt-2 text-[11px] text-slate-400">
